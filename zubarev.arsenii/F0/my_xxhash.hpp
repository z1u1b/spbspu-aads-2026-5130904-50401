#ifndef MY_XXHASH_HPP
#define MY_XXHASH_HPP
...
namespace zubarev
{
  ...
  {
  private:
    boost::hash2::xxhash_64 hasher_template_;

  public:
    XXHash(uint64_t k0 = 0x0706050403020100ULL)
    {
      hasher_template_ = boost::hash2::xxhash_64(k0);
    }

    uint64_t operator()(const void* data, size_t len) const
    {
      boost::hash2::xxhash_64 h = hasher_template_;
      h.update(data, len);
